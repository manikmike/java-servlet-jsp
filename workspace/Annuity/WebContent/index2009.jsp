...
<BODY>
<P><H1 ALIGN=LEFT>Life Tables and Annuity Values</H1>
<H2>(Based on 2009 Trustees Report)</H2>
<HR>
<FORM ACTION="/Annuity/Annuity2009" method=post>
...
<INPUT TYPE=TEXT NAME=STAYER SIZE=5 id="StartingYear" VALUE="2009">
</P>
...
<INPUT TYPE=TEXT NAME=ENDYER SIZE=5 id="EndingYear" VALUE="2009">
</P>
</TD>
...
<INPUT TYPE=TEXT SIZE=5 NAME="INT" id="InterestRate" VALUE="2.90"><STRONG>%</STRONG>
