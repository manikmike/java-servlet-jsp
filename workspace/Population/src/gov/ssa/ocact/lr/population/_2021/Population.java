package gov.ssa.ocact.lr.population._2021;
...
public class Population  {
   ...
   private static final int TRYEAR = 2021;
   ...
   private synchronized boolean readDataFiles() {
       ...
       boolean rv = true;
       String filename[] = {"PopJanMS.hist",
               "PopJanMS.alt1", "PopJanMS.alt2", "PopJanMS.alt3",
               "PopJanMS.fer1", "PopJanMS.fer3",
               "PopJanMS.imm1", "PopJanMS.imm3",
               "PopJanMS.mor1", "PopJanMS.mor3",
               "PopJanMS.mar1", "PopJanMS.mar3",
               "PopJanMS.div1", "PopJanMS.div3",
               "PopJulMS.hist",
