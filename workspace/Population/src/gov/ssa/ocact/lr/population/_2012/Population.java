package gov.ssa.ocact.lr.population._2012;
...
public class Population  {
   ...
   static {
	   ...
	   String filename[] = {"compopasc.hist",
			   "compopasc.alt1", "compopasc.alt2", "compopasc.alt3",
			   "compopasc.fer1", "compopasc.fer3",
			   "compopasc.imm1", "compopasc.imm3",
			   "compopasc.mor1", "compopasc.mor3",
			   "compopasc.mar1", "compopasc.mar3",
			   "compopasc.div1", "compopasc.div3"};
   ...
   public Population (HttpServletRequest request,
         ...
         if (month.equals("DEC") || month.equals("JUL")) {
        	 if (end_year >= 2101) {
        		 end_year = 2100;
        		 String title = "Maximum year is 2100.  Please go back and try again.";
        		 out.println("<HTML>\n" + "<HEAD><TITLE>" + title + "</TITLE></HEAD>\n" +
        				 "<H1>" + title + "</H1>");        	 
        		 }
         }
         if (month.equals("JAN")) {
        	 if (end_year > 2101) {
        		 end_year = 2101;
        		 String title = "Maximum year is 2101.  Please go back and try again.";
        		 out.println("<HTML>\n" + "<HEAD><TITLE>" + title + "</TITLE></HEAD>\n" +
        				 "<H1>" + title + "</H1>");  
        	 }
         }
