...
<H3>(Based on 2010 Trustees Report)</H3>
<P></P>
<HR>

<FORM name=form1 action="/Population/Population2010" method="post">
<TABLE>
  <TBODY>
  <TR>
      ...
      <TABLE>
        ...
        <TR>
          ...
          <TD><SELECT name=STADEC> <OPTION value=0>0<OPTION 
              value=1 selected>1<OPTION value=2>2<OPTION value=3>3<OPTION 
              value=4>4<OPTION value=5>5<OPTION value=6>6<OPTION 
              value=7>7<OPTION value=8>8<OPTION value=9>9</OPTION></SELECT> </TD>
          <TD><SELECT name=STAYER> <OPTION value=0 selected>0<OPTION value=1>1<OPTION 
      ...
      <TABLE>
        ...
        <TR>
          ...
          <TD><SELECT name=ENDDEC> <OPTION value=0>0<OPTION 
              ...
              value=4>4<OPTION value=5>5<OPTION value=6>6<OPTION 
              value=7>7<OPTION value=8>8<OPTION value=9>9</OPTION></SELECT> </TD>
          <TD><SELECT name=ENDYER> <OPTION value=0 selected>0<OPTION value=1>1<OPTION 
              value=2>2<OPTION value=3>3<OPTION value=4>4<OPTION 
              value=5>5<OPTION value=6>6<OPTION value=7>7<OPTION value=8 
              >8<OPTION value=9>9</OPTION></SELECT> 
      </TD></TR></TBODY></TABLE>
