...
<H3>(Based on 2015 Trustees Report)</H3>
<P></P>
<HR>

<FORM name=form1 action="/Population/Population2015" method="post">
<TABLE>
  <TBODY>
  <TR>
      ...
      <TABLE>
        ...
        <TR>
          ...
          <TD><SELECT name=STAYER> <OPTION value=0>0<OPTION value=1>1<OPTION 
              ...
              value=5 selected>5<OPTION value=6>6<OPTION value=7>7<OPTION value=8 
