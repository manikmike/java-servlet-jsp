...
<H3>(Based on 2012 Trustees Report)</H3>
<P></P>
<HR>

<FORM name=form1 action="/Population/Population2012" method="post">
<TABLE>
  <TBODY>
  <TR>
      ...
      <TABLE>
        ...
        <TR>
          ...
          <TD><SELECT name=STAYER> <OPTION value=0>0<OPTION value=1>1<OPTION 
              value=2 selected>2<OPTION value=3>3<OPTION value=4>4<OPTION 
