...
<H3>(Based on 2009 Trustees Report)</H3>
<P></P>
<HR>

<FORM name=form1 action="/Population/Population2009" method="post">
<TABLE>
  <TBODY>
  <TR>
    <TD vAlign=top width=150><!-- Month -->
      <P><STRONG>Month Basis</STRONG><BR><INPUT type=radio CHECKED value=JAN 
      name=MONTH>January<BR><INPUT type=radio value=JUL name=MONTH>July<BR><!-- Type -->
    ...
    <TD vAlign=top><!-- Step Size -->
      ...
      <TABLE>
        ...
        <TR>
          ...
          <TD><SELECT name=STADEC> <OPTION value=0 selected>0<OPTION 
      ...
      <TABLE>
        ...
        <TR>
          <TD><SELECT name=ENDCEN> <OPTION value=19>19<OPTION value=20 
              selected>20<OPTION value=21>21</OPTION></SELECT> </TD>
          <TD><SELECT name=ENDDEC> <OPTION value=0 selected>0<OPTION 
              value=1>1<OPTION value=2>2<OPTION value=3>3<OPTION 
              value=4>4<OPTION value=5>5<OPTION value=6>6<OPTION 
              value=7>7<OPTION value=8>8<OPTION value=9>9</OPTION></SELECT> </TD>
          <TD><SELECT name=ENDYER> <OPTION value=0>0<OPTION value=1>1<OPTION 
              value=2>2<OPTION value=3>3<OPTION value=4>4<OPTION 
              value=5>5<OPTION value=6>6<OPTION value=7>7<OPTION value=8 
              >8<OPTION value=9 selected>9</OPTION></SELECT> 
      </TD></TR></TBODY></TABLE>
